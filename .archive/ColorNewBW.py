'''
Black and White Colorization(Training)

Reference: https://github.com/emilwallner/Coloring-greyscale-images/blob/master/Full-version/full_version.ipynb
...
for i in range(len(output)):
    ...
    #cur2=img_as_ubyte(cur)
    #if i==0:
     # print(cur2)
    #imsave("result/img_"+str(i)+".png", img_as_ubyte(cur2))
    # suppose that img's dtype is 'float64'
    img_uint8 = cur.astype(np.uint8)
    # and then
