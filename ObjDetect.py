...
detector.loadModel()
detections = detector.detectObjectsFromImage(input_image=os.path.join(execution_path , image+"street.jpeg"), output_image_path=os.path.join(execution_path , image+"imagenew.jpg"))
